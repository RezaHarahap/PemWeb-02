    ...
    <br>
        ...
        <div class="form-group row">
            ...
            <div class="input-group">
                ...
                <input id="text" name="nama" placeholder="masukkan nama" type="text" class="form-control">
            </div>
            </div>
        </div>
        <div class="form-group row">
        ...
        <div class="form-group row">
            ...
            <div class="col-8">
            <input id="uts" name="uts" placeholder="Masukkan Nlai UTS" type="text" class="form-control">
            </div>
        </div>
        <div class="form-group row">
